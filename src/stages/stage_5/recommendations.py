...
class RecommendationGenerator:
    ...
    def _prepare_recommendations(self,
        ...
        # Обеспечиваем, что у нас есть допустимые объекты
        block_trades = block_trades or {}
        ...
        analysis = technical.get('analysis', {}) or {}
        technical_sentiment = analysis.get('overall_signal', 'нейтральный')
